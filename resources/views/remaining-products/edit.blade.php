<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <form
                action="{{ route('remaining-products.update', $remainingProduct) }}"
                method="POST"
                class="space-y-6"
            >
                @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="recorded_at"
                                id="recorded_at"
                                value="{{ old('recorded_at', $remainingProduct->recorded_at->format('Y-m-d')) }}"
                                required
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="notes"
                                id="notes"
                                value="{{ old('notes', $remainingProduct->notes) }}"
                    ...
                    <div class="mb-4 flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Update the estimated remaining servings.
                            </p>
                        </div>
